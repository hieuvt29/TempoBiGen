...
if __name__ == '__main__': 
    ...
    if Path(dur_dist_savepath).exists() and False:
    ...
    for cluster in sorted(hcw_cluster_durations.keys()):
        ...
        llh_bg, samples_bg = plot_dpm_truncated_lognormal_mixture(ax, durations, weights_tl, means_tl, sigmas_tl, 
                                                                    list(ubs)*duration_sampling_rate, 
                                                                    list(lbs)*duration_sampling_rate, 
                                                                    color='green', 
                                                                    show_samples=True)
    ...
    logging.info("Average log likelihood of the fitted distributions", np.mean(all_llhs))
    #
    min_t = 1
