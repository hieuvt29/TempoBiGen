...
export gg_savedir="results_$model_name"

python graph_generation_from_sampled_random_walks.py \
...
for ((i=0; i<$num_of_sampled_graphs; i++)); do
    ...
    python ../convert_gen_graph_to_dataobj.py --time_window $eval_time_window \
        --opath $config_path/$gg_savedir/original_graphs.pkl \
        --gpath $config_path/$gg_savedir/sampled_graph_${i}.pkl \
